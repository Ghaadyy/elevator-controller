...
\usepackage[bookmarks, colorlinks=false, pdfborder={0 0 0}, pdftitle={A Functional HTML Parser}, pdfauthor={Ghady Youssef, Antoine Karam}, pdfsubject={A Functional HTML Parser}, pdfkeywords={Functional Programming, Parser Combinators, Monads}]{hyperref}
